          ...
          <ProjectCard
            ...
            description={
              translation
                ...
                : "Dev Movies is a full-stack platform that allows users to sign up and post their own movie reviews on the platform, as well as view reviews from other users. You are able create, edit, and delete reviews."
            }
            reverse={false}
            technologies={[
              "TypeScript",
