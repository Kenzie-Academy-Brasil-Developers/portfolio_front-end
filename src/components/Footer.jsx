  ...
  return (
    <>
      <Fade triggerOnce={true} duration={3000}>
        <div
          id="footer"
          className="lg:w-2/3 w-5/6 mx-auto py-10 mb-10 mt-20 border-t-2 border-b-2 border-white flex lg:flex-row flex-col lg:gap-0 gap-3 lg:justify-between items-center"
        >
